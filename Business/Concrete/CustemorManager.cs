...
namespace Business.Concrete
{
    public class CustomerManager : ICustomerService
    {
        ...
        {
            return new SuccessDataResult<Customer>(_customerDal.Get(p => p.Id == id), Message.Listed);
        }

        public IDataResult<Customer> GetByUserId(int id)
        {
            return new SuccessDataResult<Customer>(_customerDal.Get(p => p.UserId == id), Message.Listed);
        }
